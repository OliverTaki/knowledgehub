...
Run-Step "Commit public Wire changes" {
    Invoke-Native git add scripts/build-wire.mjs scripts/build-site.mjs scripts/import-legacy-blogger.mjs scripts/wire-push.ps1 data/tag-taxonomy.json data/editorial-label-model.json data/legacy-blogger-articles.json data/legacy-blogger-source-notes.json data/legacy-blogger-wire.json public package.json package-lock.json .github/workflows/deploy.yml wrangler.jsonc
